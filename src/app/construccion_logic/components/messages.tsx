  ...
  return (
    <div className="fixed top-0 right-2/5 transform translate-x-1/2 mt-4 flex flex-col items-center w-full max-w-2xl z-10">
      <button
        ...
        className="block w-auto p-2 text-center bg-[#f7cd8d] font-comic mt1 text-[#b7632b] border-[3px] border-[#b7632b] rounded-lg font-bold uppercase duration-200 mb-4 z-5"
      >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-4 overflow-hidden">
            ...
            >
              ...
              {/* <input 
                            ...
                            /> */}
              <h2 className="text-black font-comic mt1 font-bold ml-2 mt-1 mb-1">
                From: {(session?.user as any)?.fullname.toUpperCase()}, To:
              </h2>
              <select
                value={recipient}
                onChange={(e) => setRecipient(e.target.value)}
              ...
              >
                <option className="font-comic mt1" value="">
                  Select a user...
                </option>
                {users.map((user) => (
                  <option
              ...
              <button
                ...
                className="w-full p-1 text-black font-comic mt1 border border-black rounded-lg font-bold uppercase mt-2 hover:bg-lightgray"
              >
                SEND
              </button>
              {confirmation && (
