  ...
  return (
    <main className="container mx-auto flex flex-col justify-center items-center min-h-screen bg-black">
      ...
      <h2
        ...
        className="text-2xl font-bold mb-6 text-center w-full text-red-500 mr-5"
      >
        {" "}
        COMO TE LA VAS A OLVIDAR GIL{" "}
      </h2>
      <div className="justify-center flex items-center">
        ...
        >
          ...
          />
          <button className="text-1xl text-center text-white p-1 border border-white rounded-lg hover:bg-gray-900 mb-4 mr-2">
            Submit
          </button>
